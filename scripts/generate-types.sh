...
export type Settings = { discordWebhookUrl?: string; discordEnabled?: boolean; portainerUrl?: string; portainerApiKey?: string; portainerEnabled?: boolean; aiEnabled?: boolean; aiProvider?: string; aiBlockRiskThreshold?: number; openaiKey?: string; openaiModel?: string; anthropicKey?: string; anthropicModel?: string; geminiKey?: string; geminiModel?: string; instanceUrl?: string; validateUrlPattern?: string; uiAnimationsEnabled?: boolean; automationIgnoredContainers?: string; malwareIgnoredMounts?: string; autoUpgradeMaxConcurrency?: number; autoUpgradeMinRetryMinutes?: number; clamavSnapshotMaxBytes?: number; environmentOverrides?: Record<string, boolean> };
GEN_TS
