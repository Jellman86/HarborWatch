...
type Settings struct { DiscordWebhookURL string `json:"discordWebhookUrl"`; PortainerURL string `json:"portainerUrl"`; PortainerApiKey string `json:"portainerApiKey"`; AIProvider string `json:"aiProvider"`; OpenAIKey string `json:"openaiKey"`; OpenAIModel string `json:"openaiModel"`; AnthropicKey string `json:"anthropicKey"`; AnthropicModel string `json:"anthropicModel"`; GeminiKey string `json:"geminiKey"`; GeminiModel string `json:"geminiModel"`; InstanceURL string `json:"instanceUrl"`; ValidateURLPattern string `json:"validateUrlPattern"`; EnvironmentOverrides map[string]bool `json:"environmentOverrides"` }
GEN_GO
