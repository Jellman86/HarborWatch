...
export type Settings = { discordWebhookUrl?: string; discordEnabled?: boolean; gotifyUrl?: string; gotifyToken?: string; portainerUrl?: string; portainerApiKey?: string; portainerEnabled?: boolean; aiEnabled?: boolean; aiProvider?: string; openaiKey?: string; openaiModel?: string; anthropicKey?: string; anthropicModel?: string; geminiKey?: string; geminiModel?: string; instanceUrl?: string; validateUrlPattern?: string; uiAnimationsEnabled?: boolean; environmentOverrides?: Record<string, boolean> };
