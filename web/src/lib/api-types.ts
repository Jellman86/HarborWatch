...
export type JobProgress = { id: string; type: string; target: string; status: string; message: string; progress: number; startedAt: number };
...
export type JobProgress = { id: string; type: string; target: string; status: string; progress: number; startedAt: number };
